...
//    (c) Version 0.22. January 2010 
//
//    EXPERIMENTAL -> compile opencv & libfreenect                                 
//                                                                    
//===========================================================================================// 
//     cvOpenKinectDepthTrack22.cpp   
//     ---------------------------    
//     
//     begin     : Fri. 14. January 16.15:00 GMT 2010                            
//     copyright : (C) 2008/2009/2010 by  s.morf 
//     email     : stevenmorf@bluewin.ch 
//     originalCompile with   
//     opencv & openkinect  
//     g++ -fPIC -g -Wall -I/usr/local/include/opencv -L /usr/local/lib -lcxcore -lcv -lhighgui -lcvaux -lml -o cvOpenKinectDepthTrack22 cvOpenKinectDepthTrack22.cpp -lfreenect -lm 

//     run as    : ./cvOpenKinectDepthTrack22
//
//    for: 
...
*************************************************************************************************
NOTES:
this are early lib's ev. error with compile 
...
int BodyContours()
  {
     ...
     IMG_8UC1 = cvLoadImage("bw1.jpg",-1);     
